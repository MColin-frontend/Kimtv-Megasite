    ...
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-4 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="relative flex select-none items-center justify-center gap-4">
              <span
                className="text-[48px] font-800 leading-none text-gold/60 max-sm:text-[32px]"
                aria-hidden
              ...
              <h1
                className="font-800 leading-none text-gold"
                style={{
              ...
              >
                ...
                <span className="relative inline-block">
                  ...
                  >
                    <span
                      className="inline-block text-[0.8em] animate-[spin_8s_linear_infinite]"
            ...
            <div className="flex flex-col gap-2">
              ...
              <h2
                className="font-800 uppercase leading-none text-white"
                style={{
            ...
            <Typography
              variant="h6"
              className="max-w-sm text-white/80"
            >
            ...
            <div className="mt-2 flex items-center gap-4 max-sm:w-full max-sm:flex-col max-sm:gap-3">
              <Link
                href={`/${lang}`}
                className="rounded-8 flex items-center gap-2 bg-gold px-6 py-3 font-700 text-black shadow-[0_0_24px_rgba(246,195,67,0.5)] transition-all hover:scale-[1.03] hover:shadow-[0_0_36px_rgba(246,195,67,0.7)] active:scale-95 max-sm:w-full max-sm:justify-center"
              >
                <Home className="size-4 shrink-0" />
                <Typography as="span" variant="body-lg" weight="700" className="text-black leading-none">
                  {t("common.not-found.home")}
                </Typography>
              </Link>
              <Link
                href={`/${lang}/lich-thi-dau`}
                className="rounded-8 flex items-center gap-2 border border-white/30 bg-white/10 px-6 py-3 font-700 text-white backdrop-blur-sm transition-all hover:border-white/50 hover:bg-white/[0.18] hover:scale-[1.03] active:scale-95 max-sm:w-full max-sm:justify-center"
              >
                <Calendar className="size-4 shrink-0" />
                <Typography as="span" variant="body-lg" weight="700" className="text-white leading-none">
            ...
            {/* Hint */}
            <Typography variant="body" className="mt-2 text-white/50">
              {t("common.not-found.hint")}
            </Typography>
          </div>

...
function PlayerRow({ item, rank }: { item: PlayerStatInterface; rank: number }) {
  ...
  return (
    <div className="rounded-8 flex min-w-0 items-center gap-3 bg-white/[0.04] px-2 py-2 shadow-[0_2px_8px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.06)] transition-all duration-200 hover:bg-white/[0.07] hover:shadow-[0_4px_16px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.1)]">
      {/* Rank badge */}
